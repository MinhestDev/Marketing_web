...
class WishlistController extends Controller
{
    ...
    public function wishlist(Request $request){
        ...
        if($already_wishlist) {
            request()->session()->flash('error','Khóa học đã được đưa vào danh sách yêu thích');
            return back();
        }else{
        ...
        request()->session()->flash('success','Khóa học được thêm vào danh sách yêu thích thành công');
        return back();
    }

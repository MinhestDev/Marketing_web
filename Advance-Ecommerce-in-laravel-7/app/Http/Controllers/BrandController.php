...
class BrandController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Đã tạo thành công');
        }
        else{
    ...
    public function edit($id)
    {
        $brand=Brand::find($id);
        if(!$brand){
            request()->session()->flash('error','Không tìm thấy đội ngũ này');
        }
    ...
    public function destroy($id)
    {
        ...
        if($brand){
            ...
            request()->session()->flash('error','Không tìm thấy đội ngũ');

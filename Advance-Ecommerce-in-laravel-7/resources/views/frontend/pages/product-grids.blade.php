                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="blog-single.html">Hiển thị dạng lưới</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        ...
                        <div class="row">
                            ...
                            @if(count($products)>0)
                                ...
                                @endforeach
                            @else
                                    <h4 class="text-warning" style="margin:100px auto;">Không có khóa học.</h4>
                            @endif
                                        ...
                                        <div class="quickview-content">
                                            ...
                                            <div class="quickview-ratting-review">
                                                ...
                                                <div class="quickview-stock">
                                                    @if($product->stock >0)
                                                    <span><i class="fa fa-check-circle-o"></i> {{$product->stock}} chỗ trong lớp</span>
                                                    @else
                                                    <span><i class="fa fa-times-circle-o text-danger"></i> {{$product->stock}} full lớp</span>
                                                    @endif
                                                </div>
                                            </div>
                                            @php

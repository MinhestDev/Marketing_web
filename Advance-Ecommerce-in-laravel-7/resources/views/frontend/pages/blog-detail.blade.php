...
@section('title','Easy To Learn | Chi tiết bài viết')
                    ...
                    <div class="blog-single-main">
                        <div class="row">
                            ...
                            <div class="col-12 mt-4">
                                <div class="reply">
                                    <div class="reply-head comment-form" id="commentFormContainer">
                                        <h2 class="reply-title">Rời bình luận</h2>
                                        <!-- Comment Form -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Bình luận bài đăng</span><span class="comment_btn reply" style="display: none;">Phản hồi bình luận</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                                Bạn phải <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đăng nhập</a> HOẶC <a style="color:blue" href="{{route('register.form')}}">Đăng ký</a> để bình luận.
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget recent-post">
                            <h3 class="title">Bài viết hiện tại</h3>
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                <h4>Đăng ký để nhận <br> những cập nhật mới nhất.</h4>

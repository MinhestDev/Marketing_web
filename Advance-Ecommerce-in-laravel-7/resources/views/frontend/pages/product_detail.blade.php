...
@endsection
@section('title','Easy To Learn | Chi tiết khóa học')
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="">Chi tiết khóa học</a></li>
							</ul>
						</div>
					</div>
				</div>
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="product-buy">
												...
												@endif
												<p class="availability">Chỗ học : @if($product_detail->stock>0)<span class="badge badge-success">{{$product_detail->stock}}</span>@else <span class="badge badge-danger">{{$product_detail->stock}}</span>  @endif</p>
											</div>
											<!--/ End Product Buy -->
										</div>
									</div>
															...
															<div class="col-12">
																...
																<div class="comment-review">
																	<div class="add-review">
																		...
																		<p>Địa chỉ email của bạn sẽ không được hiển thị. Các trường bắt buộc được đánh dấu</p>
																	</div>
                        ...
                        <div class="quickview-content">
                            ...
                            <div class="quickview-ratting-review">
                                <div class="quickview-ratting-wrap">
                                    ...
                                    <a href="#"> (1 sinh viên bình luận)</a>
                                </div>

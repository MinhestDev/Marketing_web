...
@section('title','Easy To Learn | Trang yêu thích')
							...
							@else
								<tr>
									<td class="text-center">
										Không có bất kỳ danh sách mong muốn nào có sẵn. <a href="{{route('product-grids')}}" style="color:blue;">Tiếp tục mua hàng</a>

...
@section('title','Easy To Learn | Trang sản phẩm')
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="javascript:void(0);">Danh sách khóa học</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-3 col-md-4 col-12">
							<div class="shop-sidebar">
                                ...
                                <div class="single-widget category">
                                    <h3 class="title">Danh mục khóa học</h3>
						...
						<div class="col-lg-9 col-md-8 col-12">
										...
										<div class="shop-shorter">
											...
											<div class="single-shorter">
												...
												<select class='sortBy' name='sortBy' onchange="this.form.submit();">
													...
													<option value="category" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='category') selected @endif>Danh mục khóa học</option>
													<option value="brand" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='brand') selected @endif>Đội ngũ</option>
												</select>
											</div>
										</div>
										<ul class="view-mode">
							...
							<div class="row">
								@if(count($products))
									...
									@endforeach
								@else
									<h4 class="text-warning" style="margin:100px auto;">Không có khóa học nào.</h4>
								@endif
							</div>
							 <div class="row">
											...
											<div class="quickview-content">
												...
												<div class="quickview-ratting-review">
													<div class="quickview-ratting-wrap">
														...
														<a href="#"> ({{$rate_count}} học viên đánh giá)</a>
													</div>
													<div class="quickview-stock">
														@if($product->stock >0)
														<span><i class="fa fa-check-circle-o"></i> {{$product->stock}} có thể đăng ký</span>
														@else
														<span><i class="fa fa-times-circle-o text-danger"></i> {{$product->stock}} hết chỗ</span>
														@endif
													</div>
												</div>
												@php

...
@section('title','Easy To Learn | Trang giỏ hàng')
								...
								@else
										<tr>
											<td class="text-center">
												Không có bất kỳ khóa học nào có sẵn. <a href="{{route('product-grids')}}" style="color:blue;">Tiếp tục tìm kiếm</a>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Bạn đã tiết kiệm<span>{{number_format(Session::get('coupon')['value'],0)}} vnđ</span></li>
										@endif
										@php

...
@section('title','Easy To Learn | Quản lý bài đăng')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('post.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Thêm bài đăng"><i class="fas fa-plus"></i> Thêm bài đăng</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">Không tìm thấy bài đăng, hãy thêm bài đăng.</h6>
        @endif
      </div>
    </div>
</div>

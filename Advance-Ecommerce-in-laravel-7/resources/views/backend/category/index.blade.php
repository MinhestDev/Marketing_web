...
@section('title','Easy To Learn | Quản lý danh mục khóa học')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Danh sách danh mục khóa học</h6>
      <a href="{{route('category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Thêm danh mục"><i class="fas fa-plus"></i> Thêm danh mục khóa học</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">Không tìm thấy danh mục khóa học, hãy thêm dmới</h6>
        @endif
      </div>
    </div>
</div>

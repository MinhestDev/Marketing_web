...
@section('title','Easy To Learn | Sửa thông tin Website')
@section('main-content')

<div class="card">
    <h5 class="card-header">Sửa thông tin Website</h5>
    <div class="card-body">
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
          <label for="inputPhoto" class="col-form-label">Ảnh trang về chúng tôi<span class="text-danger">*</span></label>
          <div class="input-group">
              <span class="input-group-btn">

...
@section('title','Easy To Learn | Trang đội ngũ')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Danh sách đội ngũ</h6>
      <a href="{{route('brand.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Thêm đội ngũ"><i class="fas fa-plus"></i> Thêm đội ngũ</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">Không tìm thấy đội ngũ, hãy tạo mới</h6>
        @endif
      </div>
    </div>
</div>

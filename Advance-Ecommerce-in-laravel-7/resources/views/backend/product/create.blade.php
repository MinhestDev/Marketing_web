...
@section('title','Easy To Learn | Tạo khóa học')
...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          <label for="is_featured">Là danh mục cha không?</label><br>
        ...
        <div class="form-group">
          ...
          <input id="discount" type="number" name="discount" min="0" max="100" placeholder="Nhập số giảm giá"  value="{{old('discount')}}" class="form-control">
          @error('discount')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
...
<script>
    ...
    $(document).ready(function() {
      $('#description').summernote({
        placeholder: "Chọn mô tả chi tiết.....",
          tabsize: 2,
          height: 150
      });
    });

...
@section('title','Easy To Learn | Sửa khóa học')
@section('main-content')

<div class="card">
    <h5 class="card-header">Sửa khóa học</h5>
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          <label for="is_featured">Là thư mục cha không?</label><br>
        ...
        <div class="form-group {{(($product->child_cat_id)? '' : 'd-none')}}" id="child_cat_div">
          ...
          <select name="child_cat_id" id="child_cat_id" class="form-control">
              <option value="">--Chọn hạng mục phụ--</option>
        ...
        <div class="form-group">
          ...
          <input id="discount" type="number" name="discount" min="0" max="100" placeholder="Nhập số giảm giá"  value="{{$product->discount}}" class="form-control">
          @error('discount')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          <label for="brand_id">Đội ngũ</label>
            ...
            if(cat_id !=null){
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        var html_option="<option value=''>--Chọn một cái bất kỳ--</option>";
                        if(response.status){

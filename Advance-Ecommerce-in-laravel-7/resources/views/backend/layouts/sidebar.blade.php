<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin')}}">
      <div class="sidebar-brand-icon">
        ...
        <img style="width: 70px" src="backend/img/easy-to-learn.png" alt="">
      </div>
    ...
    <li class="nav-item">
        ...
        <div id="categoryCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('category.index')}}">Danh mục khóa học</a>
            <a class="collapse-item" href="{{route('category.create')}}">Thêm danh mục khóa học</a>
          </div>
        </div>
    </li>
    {{-- Products --}}
    <li class="nav-item">
        ...
        <div id="productCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Tùy chọn khóa học:</h6>
            <a class="collapse-item" href="{{route('product.index')}}">Khóa học</a>
            <a class="collapse-item" href="{{route('product.create')}}">Thêm khóa học</a>
          </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="brandCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Tùy chọn đội ngũ:</h6>
            <a class="collapse-item" href="{{route('brand.index')}}">Đội ngũ</a>
            <a class="collapse-item" href="{{route('brand.create')}}">Thêm đội ngũ</a>
          </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="shippingCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Tùy chọn đơn vị vận chuyển:</h6>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#tagCollapse" aria-expanded="true" aria-controls="tagCollapse">
            ...
            <span>Thẻ ghim bài đăng</span>
        </a>
        <div id="tagCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Tùy chọn thẻ ghim bài đăng:</h6>
            <a class="collapse-item" href="{{route('post-tag.index')}}">Thẻ ghim bài đăng</a>
            <a class="collapse-item" href="{{route('post-tag.create')}}">Thêm thẻ ghim bài đăng</a>
            </div>
        </div>
    </li>

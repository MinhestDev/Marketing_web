...
@section('title','Easy To Learn | Dashboard Admin')
        ...
        <table class="table table-bordered" id="order-dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            @if(count($orders)>0)
              ...
              @endforeach
              @else
                <td colspan="8" class="text-center"><h4 class="my-4">Bạn chưa có đơn đặt hàng nào! Hãy đặt một khóa học mong muốn.</h4></td>
              @endif
          </tbody>
        </table>
